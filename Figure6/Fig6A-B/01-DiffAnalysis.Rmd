...
```
```{r}
my.file=system.file("/Users/magalhae/Desktop/Julian_ChIP_CEBPA/SE/REs_BtoiMac/BLaER_SE.bed",package="genomation")
refseq = readBed("/Users/magalhae/Desktop/Julian_ChIP_CEBPA/SE/REs_BtoiMac/BLaER_SE.bed",track.line=FALSE,remove.unusual=FALSE)
```

```{r}

BLaER_S_gr =  readBed("/Users/magalhae/Desktop/Julian_ChIP_CEBPA/SE/REs_BtoiMac/BLaER_SE_cut.bed",track.line=FALSE,remove.unusual=FALSE)
enhancers_gr =  readBed("/Users/magalhae/Desktop/Julian_ChIP_CEBPA/SE/REs_BtoiMac/enhancers_sorted_cut.bed",track.line=FALSE,remove.unusual=FALSE)
iMac_SE_gr =  readBed("/Users/magalhae/Desktop/Julian_ChIP_CEBPA/SE/REs_BtoiMac/iMac_SE_cut.bed",track.line=FALSE,remove.unusual=FALSE)
promoters_gr =  readBed("/Users/magalhae/Desktop/Julian_ChIP_CEBPA/SE/REs_BtoiMac/promoters_sorted_cut.bed",track.line=FALSE,remove.unusual=FALSE)
common_gr = readBed("/Users/magalhae/Desktop/Julian_ChIP_CEBPA/ToMErge/Common_Sites_cut.bed",track.line=FALSE,remove.unusual=FALSE)



BLaER_S_obj =  read.table("/Users/magalhae/Desktop/Julian_ChIP_CEBPA/SE/REs_BtoiMac/BLaER_SE.bed", header = FALSE)
enhancers_obj =  read.table("/Users/magalhae/Desktop/Julian_ChIP_CEBPA/SE/REs_BtoiMac/enhancers_sorted.bed", header = FALSE)
iMac_SE_obj =  read.table("/Users/magalhae/Desktop/Julian_ChIP_CEBPA/SE/REs_BtoiMac/iMac_SE.bed", header = FALSE)
promoters_obj =  read.table("/Users/magalhae/Desktop/Julian_ChIP_CEBPA/SE/REs_BtoiMac/promoters_sorted.bed", header = FALSE)
common_obj = read.table("/Users/magalhae/Desktop/Julian_ChIP_CEBPA/ToMErge/Common_Sites.bed", header = FALSE)
